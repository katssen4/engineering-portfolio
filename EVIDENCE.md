# Evidence: evaluation and governance for enterprise AI

The long version behind the [README](README.md). Every number here is either recomputed by
`tools/verify.py` or declared with the command that produced it.
